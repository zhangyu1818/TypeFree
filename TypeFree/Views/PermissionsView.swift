...
struct PermissionCard: View {
    ...
    var infoTipTitle: LocalizedStringKey?
            ...
            HStack(spacing: 16) {
                ...
                VStack(alignment: .leading, spacing: 4) {
                    HStack {
                        Text(title)
                            .font(.headline)
                        if let infoTipTitle, let infoTipMessage {
                            InfoTip(
                                title: infoTipTitle,
            ...
            VStack(spacing: 32) {
                ...
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 8) {
                        ...
                        Text("TypeFree requires the following permissions to function properly")
                            .font(.system(size: 15))
                ...
                VStack(spacing: 16) {
                    ...
                    PermissionCard(
                        ...
                        description: "Set up a keyboard shortcut to use TypeFree anywhere",
                    ...
                    PermissionCard(
                        ...
                        description: "Allow TypeFree to record your voice for transcription",
                    ...
                    PermissionCard(
                        ...
                        description: "Allow TypeFree to paste transcribed text directly at your cursor position",
                        ...
                        infoTipMessage: "TypeFree uses Accessibility permissions to paste the transcribed text directly into other applications at your cursor's position. This allows for a seamless dictation experience across your Mac."
                    )
                    ...
                    PermissionCard(
                        ...
                        description: "Allow TypeFree to understand context from your screen for transcript Enhancement",
                        ...
                        infoTipMessage: "TypeFree captures on-screen text to understand the context of your voice input, which significantly improves transcription accuracy. Your privacy is important: this data is processed locally and is not stored.",
                        infoTipLink: "https://trytypefree.com/docs/contextual-awareness"
                    )
                }
            }
            .padding(24)
