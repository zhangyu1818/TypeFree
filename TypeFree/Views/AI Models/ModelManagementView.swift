...
struct ModelManagementView: View {
    ...
    private var defaultModelSection: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            Text(LocalizedStringKey(whisperState.currentTranscriptionModel?.displayName ?? "No model selected"))
                .font(.title2)
                .fontWeight(.bold)
        }
        .padding()
                    ...
                    if selectedFilter == .local {
                        HStack(spacing: 8) {
                            ...
                            InfoTip(
                                ...
                                message: "Add a custom fine-tuned whisper model to use with TypeFree. Select the downloaded .bin file.",
                                learnMoreURL: "https://trytypefree.com/docs/custom-local-whisper-models"
                            )
    ...
    private var filteredModels: [any TranscriptionModel] {
        ...
        case .local:
            whisperState.allAvailableModels.filter { $0.provider == .local || $0.provider == .nativeApple || $0.provider == .parakeet }
        case .custom:
            whisperState.allAvailableModels.filter { $0.provider == .custom }
        }
    }
