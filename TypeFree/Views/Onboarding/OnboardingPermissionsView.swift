...
struct OnboardingPermission: Identifiable {
    ...
    enum PermissionType {
        ...
        var systemName: String {
            switch self {
            case .microphone: "mic"
            case .audioDeviceSelection: "headphones"
...
struct OnboardingPermissionsView: View {
    ...
    private let permissions: [OnboardingPermission] = [
        ...
        OnboardingPermission(
            ...
            description: "Select the audio input device you want to use with TypeFree.",
            icon: "headphones",
            type: .audioDeviceSelection
        ),
        OnboardingPermission(
            title: "Accessibility Access",
            description: "Allow TypeFree to help you type anywhere in your Mac.",
            icon: "accessibility",
            type: .accessibility
        ),
        OnboardingPermission(
        ...
        OnboardingPermission(
            ...
            description: "Set up a keyboard shortcut to quickly access TypeFree from anywhere.",
            icon: "keyboard",
                                ...
                                HStack(spacing: 8) {
                                    ...
                                    if permissions[currentPermissionIndex].type == .screenRecording {
                                        InfoTip(
                                            ...
                                            message: "TypeFree captures on-screen text to understand the context of your voice input, which significantly improves transcription accuracy. Your privacy is important: this data is processed locally and is not stored.",
                                            learnMoreURL: "https://trytypefree.com/docs/contextual-awareness"
                                        )
                                    }
                                }
                                ...
                                VStack(spacing: 20) {
                                    if audioDeviceManager.availableDevices.isEmpty {
                                        ...
                                        styledPicker(
                                            ...
                                            options: audioDeviceManager.availableDevices.map(\.id),
    ...
    private func getButtonTitle() -> LocalizedStringKey {
        ...
        case .audioDeviceSelection:
            "Continue"
        default:
            permissionStates[currentPermissionIndex] ? "Continue" : "Enable Access"
        }
    }
