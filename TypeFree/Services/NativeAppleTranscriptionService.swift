...
class NativeAppleTranscriptionService: TranscriptionService {
    private let logger = Logger(subsystem: "dev.zhangyu.typefree", category: "NativeAppleTranscriptionService")
    ...
    enum ServiceError: Error, LocalizedError {
        ...
        var errorDescription: String? {
            ...
            case .assetAllocationFailed:
                "Failed to allocate assets for the selected locale."
            }
        }
    }
    ...
    func transcribe(audioURL: URL, model: any TranscriptionModel) async throws -> String {
        ...
        // Enable by defining ENABLE_NATIVE_SPEECH_ANALYZER in build settings once building against macOS 26+ SDKs.
            ...
            var statusMessage = if isLocaleInstalled {
                "✅ Installed"
            } else if isLocaleSupported {
                "❌ Not Installed (Available for download)"
            } else {
                "❌ Not Supported"
            }
